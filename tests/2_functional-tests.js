    ...
    test("2 stocks", function(done) {
      chai.request(server)
        ...
        .end(function(err, res){
          ...
          assert.property(res.body.stockData[0], 'rel_likes2');
          assert.property(res.body.stockData[1], 'stock');
          assert.property(res.body.stockData[1], 'price');
          assert.property(res.body.stockData[1], 'likes2');
          assert.oneOf(res.body.stockData[0].stock, ['GOOG','MSFT']);
          assert.oneOf(res.body.stockData[1].stock, ['GOOG','MSFT']);
          assert.equal(res.body.stockData[0].likes2 + res.body.stockData[1].likes2, 0);
